...
var LOADABLE_STATES = Object.freeze({
  UNINITIALIZED: 'UNINITIALIZED',
  IN_PROGRESS: 'IN_PROGRESS',
  COMPLETED: 'COMPLETED',
  ERROR: 'ERROR'
});
var LOADABLE_STATES_VALUES = Object.values(LOADABLE_STATES);
var LOADABLE_MODEL_KEYS = Object.freeze({
  state: '_loadable_state'
});

var loadableSchema = _defineProperty({}, LOADABLE_MODEL_KEYS.state, LOADABLE_STATES.UNINITIALIZED);

var LoadableModel = function LoadableModel(defaultValues, name) {
  return (/*#__PURE__*/function (_Model) {
      ...
      _createClass(_class, [{
        key: "_getLoadingState",
        value: function _getLoadingState() {
          return this.get(LOADABLE_MODEL_KEYS.state);
        }
      }, {
        key: "_withLoadingState",
        value: function _withLoadingState(state) {
          if (LOADABLE_STATES_VALUES.includes(state)) {
            return this.set(LOADABLE_MODEL_KEYS.state, state);
          }

          console.error("LoadableModel._withLoadingState called with incorrect param: \"".concat(state, "\". Allowed states: ").concat(LOADABLE_STATES_VALUES.join(', '), "."));
          return this;
        }
      }, {
        key: "isLoadingUninitialized",
        value: function isLoadingUninitialized() {
          return this._getLoadingState() === LOADABLE_STATES.UNINITIALIZED;
        }
      }, {
        key: "isLoadingInProgress",
        value: function isLoadingInProgress() {
          return this._getLoadingState() === LOADABLE_STATES.IN_PROGRESS;
        }
      }, {
        key: "isLoadingCompleted",
        value: function isLoadingCompleted() {
          return this._getLoadingState() === LOADABLE_STATES.COMPLETED;
        }
      }, {
        key: "isLoadingError",
        value: function isLoadingError() {
        ...
        key: "isLoadingFinished",
        value: function isLoadingFinished() {
          return this.isLoadingCompleted() || this.isLoadingError();
        }
      }, {
        key: "withLoadingInProgress",
        value: function withLoadingInProgress() {
          return this._withLoadingState(LOADABLE_STATES.IN_PROGRESS);
        }
      }, {
        key: "withLoadingCompleted",
        value: function withLoadingCompleted() {
          return this._withLoadingState(LOADABLE_STATES.COMPLETED);
        }
      }, {
        key: "withLoadingError",
        value: function withLoadingError() {
          return this._withLoadingState(LOADABLE_STATES.ERROR);
        }
      }]);

      return _class;
    }(BaseModel(_objectSpread2({}, defaultValues, {}, loadableSchema), name))
  );
};
