...
import IconClose$1 from '@wikia/react-common/icons/IconCloseSmall';
import IconTagSmall from '@wikia/react-common/icons/IconTagSmall';
import IconAddSmall from '@wikia/react-common/icons/IconAddSmall';
import IconAlertSmall from '@wikia/react-common/icons/IconAlertSmall';
import IconMagnifyingGlassSmall from '@wikia/react-common/icons/IconMagnifyingGlassSmall';
...
var Icon = styled(IconClose$1)(_templateObject2());
/**
...
var Tag = styled(StyledTag)(_templateObject$1());
...
var Tag$1 = styled(StyledTag)(_templateObject$2());
var Wrapper$2 = styled.div(_templateObject2$2());
var SuggestedLabel = styled.div(_templateObject3(), function (_ref) {
  var theme = _ref.theme;
...
var StyledList = styled.ul(_templateObject$3(), function (_ref) {
...
var ICON_STYLES = css(["fill:currentColor;height:16px;width:16px;"]);
var List = styled(StyledList)(_templateObject$4(), function (_ref) {
  var theme = _ref.theme;
...
var Slider = styled.div(_templateObject2$3(), function (_ref6) {
...
var Wrapper$3 = styled.div(_templateObject3$1(), function (_ref9) {
...
var Input = styled.input(_templateObject4(), function (_ref11) {
...
var IconSearch = styled(IconMagnifyingGlassSmall)(_templateObject5(), ICON_STYLES);
var IconClose = styled(IconClose$1)(_templateObject6(), ICON_STYLES);
...
var ICON_STYLES$1 = css(["fill:currentColor;height:18px;width:18px;"]);
var IconTag = styled(IconTagSmall)(_templateObject$5(), ICON_STYLES$1);
var IconAlert = styled(IconAlertSmall)(_templateObject2$4(), ICON_STYLES$1, function (_ref) {
  var theme = _ref.theme;
  return theme.color.fandom_red;
});
var IconAdd = styled(IconAddSmall)(_templateObject3$2());
var Wrapper$4 = styled.div(_templateObject4$1(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.media.small_down;
});
var Header = styled.div(_templateObject5$1());
var AddTagButton = styled.button(_templateObject6$1(), function (_ref3) {
...
var MaxTagsAdded = styled.div(_templateObject7());
...
var Wrapper$5 = styled.div(_templateObject$6(), function (_ref) {
  var theme = _ref.theme;
  return theme.font_size.s;
});
/**
