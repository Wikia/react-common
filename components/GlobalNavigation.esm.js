...
import LogoFandomWhite from '@wikia/react-common/assets/LogoFandomWhite';
...
var LogoFandomHeart$1 = (function (props) {
  return React.createElement(LogoFandomHeart, props);
});
...
var CommunityBar = function CommunityBar(_ref) {
  ...
  }, React.createElement(LogoFandomHeart$1, {
...
var IconMoreSmall = (({
  styles = {},
  ...props
}) => React.createElement("svg", _extends$4({
  xmlns: "http://www.w3.org/2000/svg",
  xmlnsXlink: "http://www.w3.org/1999/xlink",
  viewBox: "0 0 18 18"
}, props), React.createElement("defs", null, React.createElement("path", {
...
var I18nNamespaceContext = React.createContext(null);
...
var SearchInput = React.forwardRef(function (props, ref) {
  ...
  var _useTranslation = useTranslation(useContext(I18nNamespaceContext)),
...
var Search = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      ...
      return React.createElement("form", {
      ...
      }, React.createElement(SearchToggle, {
        ...
        noChevron: true
      }, hasSuggestions && React.createElement(List, {
...
var LinkGroup = function LinkGroup(_ref) {
  ...
  return React.createElement(Dropdown, {
    ...
    if (item.type === 'link-text') {
      linkEl = React.createElement(LinkText, {
        link: item
      });
    } else {
      linkEl = React.createElement(LinkButton, {
        link: item
      });
    }
...
var UserLoggedIn = function UserLoggedIn(_ref2) {
  ...
  return React.createElement(Dropdown, {
    toggle: function toggle(chevron) {
      return React.createElement(UserToggle, {
        chevron: chevron,
        data: data
      });
    },
    ...
    if (item.type === 'link-logout') {
      return React.createElement("li", {
        key: index
      }, React.createElement(LinkLogOut$1, {
        link: item
      }));
    }
...
var UserAnon = function UserAnon(_ref2) {
  ...
  return React.createElement(Dropdown, {
    toggle: function toggle(chevron) {
      return React.createElement(UserToggle$1, {
        chevron: chevron
      });
    },
  ...
  }, t('global-navigation-anon-register-description')), React.createElement(Button, {
...
var User = function User(_ref) {
  ...
  if (data.user) {
    return React.createElement(UserLoggedIn, {
      data: data.user
    });
  }

  if (data.anon) {
    return React.createElement(UserAnon$1, {
      data: data.anon
    });
  }
...
var MarkAllButton = function MarkAllButton(_ref) {
  ...
  var _useContext = useContext(NotificationsContext),
...
var Card = function Card(_ref) {
  ...
  return React.createElement("li", {
    className: computedClass
  }, showAvatars && React.createElement(AvatarStack, {
    overrideCount: totalUniqueActors,
    avatars: avatars
  }), React.createElement(CardLink, {
    model: model,
    track: track
  }, React.createElement(MarkAsReadIcon, {
    model: model,
    track: track
  }), React.createElement("div", {
    ...
    model: model
  }), showSnippet && React.createElement("p", {
    className: "wds-notification-card__snippet"
  }, snippet), showLastActor && React.createElement("p", {
    className: "wds-notification-card__last-actor"
  }, get_1(latestActors, '[0].name')), React.createElement("ul", {
...
var List$1 = function List(_ref) {
  ...
  }), isLoading && React.createElement("li", null, React.createElement(Spinner, {
    block: true,
    size: "28",
    stroke: "2"
  })));
...
var ListContainer = function ListContainer(_ref) {
  ...
  return React.createElement(React.Fragment, null, unreadCount > 0 && React.createElement(MarkAllButton, {
    track: track,
    header: header
  }), notifications.length || isLoading ? React.createElement(List$1, {
    track: track
...
var MobileLoggedIn = function MobileLoggedIn(_ref) {
  ...
  return React.createElement(React.Fragment, null, React.createElement(Button, {
    ...
    src: user.avatar_url,
    alt: user.username
  }), Boolean(unreadCount) && React.createElement("span", {
    className: "wds-global-navigation__avatar-notifications-counter"
  }, unreadCount > 99 ? '99+' : unreadCount)), React.createElement(UserModal, {
    user: user,
    isOpen: isOpen,
    track: track,
    header: header
...
var MobileUser = function MobileUser(_ref) {
  ...
  if (model.user) {
    return React.createElement(MobileLoggedIn, {
      user: model.user,
  ...
  if (model.anon) {
    return React.createElement(MobileAnon$1, {
      model: model.anon
    });
  }
...
var NotificationsDataProvider = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(NotificationsDataProvider, [{
    ...
    value: function render() {
      ...
      return React.createElement(NotificationsProvider, {
        value: this.state
      }, children);
    }
  }]);
...
var NotificationToggle = function NotificationToggle(_ref) {
  ...
  return React.createElement(React.Fragment, null, Boolean(unreadCount) && React.createElement("span", {
    className: "wds-global-navigation__notifications-counter"
  }, unreadCount > 99 ? '99+' : unreadCount), React.createElement(Icon, {
    name: "bell",
    className: "icon-bell"
  }), chevron);
};
...
var NotificationsDropdown = function NotificationsDropdown(_ref2) {
  ...
  return React.createElement(Dropdown, {
    ...
    toggle: function toggle(chevron) {
      return React.createElement(NotificationToggle, {
        chevron: chevron,
...
var GlobalNavigation = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(GlobalNavigation, [{
    ...
    value: function renderMainNavigation(navigation) {
      return navigation.map(function (link, index) {
        if (link.type === 'link-text') {
          return React.createElement(LinkText, {
            key: index,
            link: link,
        ...
        if (link.type === 'link-group') {
          return React.createElement(LinkGroup, {
            key: index,
            link: link
          });
        }
    ...
    value: function renderLeftBar() {
      ...
      }, React.createElement(LogoFandomWhite, {
    ...
    value: function renderRightBar() {
      ...
      return React.createElement("div", {
      ...
      }, React.createElement(CommunityBar, {
        model: model.logo,
        siteName: siteName
      }), React.createElement("div", {
        ...
        data: model
      }), model.user && React.createElement(NotificationsDropdown, {
        track: track
      }), React.createElement("div", {
        ...
        className: "wds-global-navigation__links"
      }, this.renderMainNavigation(model['main-navigation']))), React.createElement(MobileUser, {
        model: model,
        openModal: this.openModal,
    ...
    value: function render() {
      ...
      return React.createElement(I18nNamespaceProvider, {
        value: i18nNamespace
      }, React.createElement(NotificationsDataProvider, {
        ...
        ref: this.nav
      }, this.renderLeftBar(), this.renderRightBar(), partnerSlotModel && React.createElement(PartnerSlot, {
