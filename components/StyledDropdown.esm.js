...
import IconDropdownTiny from '@wikia/react-common/icons/IconDropdownTiny';
import IconMenuControlTiny from '@wikia/react-common/icons/IconMenuControlTiny';
...
var borderRadius = function borderRadius() {
  ...
  return css(["border-radius:", "px;"], size);
};
var isRightAligned = function isRightAligned() {
  return css(["left:auto;right:0;transform:none;}"]);
};
...
var DropdownContent = styled(function (_ref) {
...
var ChevronIcon = styled(IconMenuControlTiny)(_templateObject$2());

function getToggleIcon(iconName) {
  return iconName === 'dropdown-tiny' ? React.createElement(ChevronIcon, {
    as: IconDropdownTiny
...
var DropdownToggle$1 = styled(DropdownToggle)(_templateObject2());
...
var DropdownComponent = styled.div(_templateObject$3(), DropdownToggle$1, DropdownContent, function (_ref) {
...
function StyledDropdown(_ref12) {
  ...
  var contentElementRef = useRef(null);
  ...
  }, React.createElement(DropdownToggle$1, {
    attrs: toggleAttrs,
