...
import IconMagnifyingGlass from '@wikia/react-common/icons/IconMagnifyingGlass';
import IconDropdown from '@wikia/react-common/icons/IconDropdown';
...
var IndicatorsContainer = function IndicatorsContainer(props) {
  ...
  return React.createElement(components.IndicatorsContainer, props, spinner, isLoading ? null : dropdownIndicator, indicatorSeparator);
};
...
function createSelectContainer(classNamePrefix, customClassName) {
  ...
  return function (props) {
    return React.createElement("div", {
      className: className
    }, React.createElement(components.SelectContainer, props));
  };
}

var SearchDropdownIndicator = function SearchDropdownIndicator(props) {
  return React.createElement(components.DropdownIndicator, props, React.createElement(IconMagnifyingGlass, {
...
var DefaultDropdownIndicator = function DefaultDropdownIndicator(props) {
  ...
  return React.createElement(components.DropdownIndicator, props, React.createElement(IconDropdown, {
    className: className
  }));
};
...
var Select = /*#__PURE__*/function (_React$Component) {
  ...
  function Select(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onRequestNoOptionsMessage", function (_ref) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onTextInputChange", function (input) {
      if (_this.props.onTextInputChange) {
        _this.props.onTextInputChange(input);
      }
    });

    _defineProperty(_assertThisInitialized(_this), "getFlatOptions", function () {
  ...
  _createClass(Select, [{
    ...
    value: function getValueFromProps() {
      ...
      valuesWithLabels = valuesWithLabels.map(function (v) {
        return _this2.getFlatOptions().find(function (o) {
          return o.value === v;
        });
      }).filter(Boolean);
