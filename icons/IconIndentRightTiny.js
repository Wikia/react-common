...
var IconIndentRightTinySvg = ((_ref) => {
  ...
  return React.createElement(
    ...
    React.createElement("use", { fillRule: "evenodd", xlinkHref: "#id-icons/IconIndentRightTiny-a" })
  );
});
...
var IconIndentRightTiny = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconIndentRightTinySvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconIndentRightTiny;
