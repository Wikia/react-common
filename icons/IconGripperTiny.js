...
var IconGripperTiny = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconGripperTinySvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconGripperTiny;
