...
var IconMessageTiny = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconMessageTinySvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconMessageTiny;
