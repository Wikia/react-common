...
var IconIndentRightSmallSvg = ((_ref) => {
...
var IconIndentRightSmall = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconIndentRightSmallSvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconIndentRightSmall;
