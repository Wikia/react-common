...
var IconImagesTinySvg = ((_ref) => {
  ...
  return React.createElement(
    ...
    React.createElement("use", { fillRule: "evenodd", xlinkHref: "#id-icons/IconImagesTiny-a" })
  );
});
...
var IconImagesTiny = styled(IconImagesTinySvg)(_templateObject(), function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
