...
var IconPencilSmallSvg = ((_ref) => {
  ...
  return React.createElement(
    ...
    React.createElement("use", { fillRule: "evenodd", xlinkHref: "#id-icons/IconPencilSmall-a" })
  );
});
...
var IconPencilSmall = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconPencilSmallSvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconPencilSmall;
