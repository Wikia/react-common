...
var IconClipboardSmallSvg = ((_ref) => {
...
var IconClipboardSmall = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconClipboardSmallSvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconClipboardSmall;
