...
var IconControlsSmall = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconControlsSmallSvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconControlsSmall;
