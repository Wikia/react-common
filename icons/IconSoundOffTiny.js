...
var IconSoundOffTiny = styled(IconSoundOffTinySvg)(_templateObject(), function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
...
module.exports = IconSoundOffTiny;
