...
var IconImageTinySvg = ((_ref) => {
  ...
  return React.createElement(
    ...
    React.createElement("use", { fillRule: "evenodd", xlinkHref: "#id-icons/IconImageTiny-a" })
  );
});
...
var IconImageTiny = styled(IconImageTinySvg)(_templateObject(), function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
