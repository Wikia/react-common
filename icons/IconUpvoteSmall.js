...
var IconUpvoteSmall = styled(IconUpvoteSmallSvg)(_templateObject(), function (props) {
  return props.size;
}, function (props) {
  return props.size;
});
...
module.exports = IconUpvoteSmall;
