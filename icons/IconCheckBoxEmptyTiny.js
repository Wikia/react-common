...
var IconCheckBoxEmptyTinySvg = ((_ref) => {
...
var IconCheckBoxEmptyTiny = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconCheckBoxEmptyTinySvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconCheckBoxEmptyTiny;
