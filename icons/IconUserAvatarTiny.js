...
var IconUserAvatarTinySvg = ((_ref) => {
...
var IconUserAvatarTiny = styled(function (_ref) {
  var size = _ref.size,
      rest = _objectWithoutProperties(_ref, ["size"]);

  return React.createElement(IconUserAvatarTinySvg, _extends({
    height: size,
    width: size
  }, rest));
...
module.exports = IconUserAvatarTiny;
