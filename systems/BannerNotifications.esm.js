...
var schema = _defineProperty({}, BANNER_NOTIFICATIONS_MODEL_KEYS.notifications, List());
/**
 * @returns {string}
 */
...
var BannerNotificationsStoreModel = /*#__PURE__*/function (_Model) {
  _inherits(BannerNotificationsStoreModel, _Model);

  var _super = _createSuper$1(BannerNotificationsStoreModel);
  ...
  _createClass(BannerNotificationsStoreModel, [{
    ...
    value: function getNotifications() {
      var notifications = this.get(BANNER_NOTIFICATIONS_MODEL_KEYS.notifications, List()); // when it's empty, sometimes `toJS` returns Object instead of Array :(
...
var BannerNotifications = /*#__PURE__*/function (_React$Component) {
  ...
  var _super = _createSuper$2(BannerNotifications);
...
var BannerNotificationsComponent = connect(mapStateToProps, mapDispatchToProps)(BannerNotifications);

export { BannerNotificationsComponent, reducer as BannerNotificationsStore, BannerNotificationsStoreModel, addAlert, addMessage, addSuccess, addWarning, removeNotfication };
