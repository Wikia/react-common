...
var _default$1 = function _default(props) {
  return React.createElement("svg", props, React.createElement("path", {
    fillRule: "evenodd",
    d: "M10.414 9l1.417-1.416a1.003 1.003 0 0 0-.002-1.412.996.996 0 0 0-1.412-.003L9 7.585 7.584 6.17a1.003 1.003 0 0 0-1.412.002.996.996 0 0 0-.003 1.412L7.585 9 6.17 10.416a1.003 1.003 0 0 0 .002 1.412.996.996 0 0 0 1.412.003L9 10.415l1.416 1.417a1.003 1.003 0 0 0 1.412-.002.996.996 0 0 0 .003-1.412L10.415 9zm1.9-8L17 5.686v6.628L12.314 17H5.686L1 12.314V5.686L5.686 1h6.628z"
  }));
};
...
var _default$3 = function _default(props) {
  return React.createElement("svg", props, React.createElement("path", {
    fillRule: "evenodd",
    d: "M9 17A8 8 0 1 1 9 1a8 8 0 0 1 0 16zm-1.083-5a.73.73 0 0 0 .52-.22l4.33-4.403c.3-.305.312-.81.024-1.13a.722.722 0 0 0-1.062-.026l-3.83 3.895L6.25 8.563a.72.72 0 0 0-1.06.068.835.835 0 0 0 .063 1.13l2.165 2.04a.725.725 0 0 0 .5.2z"
  }));
};
...
var _default$4 = function _default(props) {
  return React.createElement("svg", props, React.createElement("path", {
    d: "M8.1 16.5l-7-13C.9 3 1 2.4 1.5 2.1c.5-.2 1.1-.1 1.4.4l7 13c.2.5.1 1.1-.4 1.4-.5.2-1.1.1-1.4-.4zM17 6.7c-2.8 2.5-6.2-.6-8.3 3.1L5.5 4.1C7.6.4 11 3.5 13.7 1L17 6.7z"
  }));
};
...
function getIcon(type) {
  switch (type) {
    case 'alert':
      return React.createElement(_default$1, {
        className: "wds-banner-notification__icon-mark"
      });

    case 'warning':
      return React.createElement(_default$2, {
        className: "wds-banner-notification__icon-mark"
      });
    ...
    default:
      return React.createElement(_default$4, {
        className: "wds-banner-notification__icon-mark"
      });
  }
}
...
var BannerNotification = function BannerNotification(_ref) {
  ...
  }, children || text), React.createElement(_default, {
