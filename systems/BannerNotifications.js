...
var BannerNotificationsStoreModel = /*#__PURE__*/function (_Model) {
  ...
  _createClass(BannerNotificationsStoreModel, [{
    ...
    value: function getNotifications() {
      var notifications = this.get(BANNER_NOTIFICATIONS_MODEL_KEYS.notifications, immutable.List()); // when it's empty, sometimes `toJS` returns Object instead of Array :(

      /* istanbul ignore next */

      return notifications.size ? notifications : immutable.List();
    }
    /**
