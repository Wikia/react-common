...
var wdsCompanyStoreGoogleplay = ((_ref) => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "linearGradient",
        { id: "a", x1: "91.536%", x2: "-37.559%", y1: "4.839%", y2: "71.968%" },
      ...
      React.createElement(
        "linearGradient",
        { id: "b", x1: "107.728%", x2: "-130.665%", y1: "49.428%", y2: "49.428%" },
    ...
    React.createElement(
      ...
      React.createElement("path", { fill: "url(#a)", d: "M9.1 6.563c-.262.262-.438.7-.438 1.224v19.338c0 .525.175.962.438 1.225l.088.087 10.85-10.85v-.174L9.1 6.563z" }),
      React.createElement("path", { fill: "url(#b)", d: "M23.625 21.262l-3.587-3.587v-.262l3.587-3.588.087.088L28 16.363c1.225.7 1.225 1.837 0 2.537l-4.375 2.363z" }),
      React.createElement("path", { fill: "url(#c)", d: "M23.712 21.175L20.038 17.5 9.1 28.438c.438.437 1.05.437 1.838.087l12.774-7.35" }),
      React.createElement("path", { fill: "url(#d)", d: "M23.712 13.825L10.938 6.563c-.788-.438-1.4-.35-1.838.087L20.038 17.5l3.674-3.675z" }),
